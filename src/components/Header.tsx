...
const Header = () => {
  ...
  return (
    <header className='dark:bg-slate-800'>
      <div className="container mx-auto pb-12 pt-6 lg:mb-0 dark:bg-slate-800">
        <div className='flex flex-wrap lg:flex-nowrap lg:px-24 lg:pt-32 lg:pb-64 lg:items-center lg:justify-items-between'>
          ...
          <div className='mt-5 lg:order-1 order-2'>
            <h1 className="text-3xl lg:text-4xl font-bold text-center lg:text-start dark:text-gray-300">Syafiq Rizky Fauzi</h1>
            <div className='w-full text-center lg:text-start'>
              <span className="text-xl lg:text-2xl lg:text-start dark:text-gray-400 lg:mt-1" ref={el}></span>
            </div>
            <p
